...
# Utilizing SampleCollection data structure of FiftyOne to consolidate the code
# This function takes in two string parameters, dataset_dir and dataset_name. It loads in datasets of type fo.types.FiftyOneDataset and returns a FiftyOne dataset object. 
